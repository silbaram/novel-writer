...
**스타일 가이드:** 프로젝트 루트의 `toby-book-writing-style.md`가 기술서/논픽션 챕터 저술의 기본 문체 기준이고, `.claude/skills/chapter-writing/references/toby-style-guide.md`가 확장 체크리스트다. 챕터 저술가와 스타일 가디언은 반드시 둘 다 준수한다.
...
**스타일 가이드:** 프로젝트 루트의 `lightnovel-style-guide.md`가 모든 챕터 집필의 제약 조건이다. `chapter-novelist`와 `novel-style-guardian`은 반드시 이를 준수한다.
