---
name: novel-editing
description: Procedural guide for integrating finalized novel chapters into season manuscripts and a full EPUB-ready manuscript. Supports novel-editor. Covers collecting chapters, building season manuscripts, building the full manuscript, preserving season transitions, checking terminology consistency, generating EPUB-compatible 04_manuscript.md and book_manifest.json. Keeps full compatibility with the existing epub-builder and build_epub.sh.
---
