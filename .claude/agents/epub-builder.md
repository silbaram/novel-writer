...
1. `{slug}/02_story_bible.md`가 있으면 **소설 모드**
2. `{slug}/02_story_bible.md`가 없고 `{slug}/02_plan.md`가 있으면 **기술서 모드**
...
{수록 시즌/권 범위 요약. 03_season_plan.md 기준으로 현재 권에서 다루는 아크를 명시한다.}

## 분위기

{톤·무드·페이싱·감정선 약속. '다음 장을 넘기게 하는 훅'을 중심으로 설명한다.}
